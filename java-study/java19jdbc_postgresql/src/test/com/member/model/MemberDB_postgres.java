...
public interface MemberDB_postgres {
    ...
    String SQL_SEARCH_LIST_NAME = "select * from member where name like ? order by num desc";
    String SQL_SEARCH_LIST_TEL = "select * from member where tel like ? order by num desc";
