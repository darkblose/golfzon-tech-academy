...
public class EmpVO implements Serializable {
	...
	public String toString() {
		return "EmpVO [employee_id=" + employee_id + ", emp_id=" + emp_id + ", first_name=" + first_name
				+ ", last_name=" + last_name + ", emp_name=" + emp_name + ", salary=" + salary + ", job_id=" + job_id
				+ ", department_id=" + department_id + ", dept_name=" + dept_name + ", job_title=" + job_title + "]";
	}
